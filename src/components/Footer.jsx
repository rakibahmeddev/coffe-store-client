...
import bgImg from '../assets/images/more/headerbg.jpg';
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 mt-8 text-white">
        <a
          href="#"
          className="hover:-translate-y-0.5 transition-all duration-300 hover:text-[#E3B578]"
        >
          <svg
            width="24"
            height="24"
